...
function calculateVolumeCylinder(radius, height) {
  ...
  // Повертаємо обчислений об'єм.
   ...
   if (typeof radius !== 'number' || typeof height !== 'number') {
    // Якщо хоча б один з аргументів не є числом, виводимо повідомлення про помилку в консоль
...
function sumPositiveNumbers(numbers) {
  ...
  // Повертаємо суму додатніх чисел.
   ...
   if (!Array.isArray(numbers)) {
    // Якщо numbers не є масивом, виводимо повідомлення "Помилка: аргумент має бути масивом чисел"
...
function getFractionalPart(num) {
  ...
  // Повертаємо дробову частину числа.
   ...
   if (typeof num !== 'number') {
    // Якщо num не є числом, виводимо повідомлення "Помилка: вхідний аргумент має бути числом."
...
function compareAndRound(num1, num2) {
  ...
  // Повертаємо округлене число.
    ...
    if (typeof num1 !== 'number' || typeof num2 !== 'number') {
      // Якщо хоча б один аргумент не є числом, виводимо повідомлення "Помилка: обидва аргументи мають бути числами."
    ...
    // Округляємо найбільше число до найближчого цілого
    const roundedNum = Math.round(maxNum);
...
function estimateInvestment(principal, interestRate, years) {
  ...
  if (typeof principal !== 'number' || typeof interestRate !== 'number' || typeof years !== 'number') {
    // Якщо хоча б один аргумент не є числом, виводимо повідомлення про помилку в консоль
